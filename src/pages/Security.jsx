...
<div className="w-full max-w-[1280px] mx-auto mb-[60px] px-4">
  ...
  <div className="relative bg-[#181818] rounded-[50px] w-[1280px] h-[700px] overflow-hidden">
    ...
    <div className="relative z-10 p-6 md:p-[40px]">
      {/* Sub Container 1: Card 1 & Card 2 (horizontal) */}
      <div className="flex flex-col gap-8">
        <div className="flex flex-row gap-8 justify-center">
          {/* Card 1 */}
          <div className="flex flex-col bg-[#232323] rounded-[20px] border border-[1px] border-[#262626] p-[40px] gap-[20px] w-[550px] h-[296px] shadow-none"
            style={{
              background: "linear-gradient(180deg, #1C1C1C 0%, #1C1C1C00 100%)",
              boxShadow: "0px 1px 2px 0px #0000000D"
            }}
          >
            <div className="flex items-center w-[470px] h-[76px] gap-[14px]">
              <div
              ...
              <span className="text-white text-[24px] font-lexend font-semibold">Secure Online Banking Platform</span>
            </div>
            <p className="text-[#b3b3b3] font-lexend font-light text-[16px] leading-[150%] w-[470px] h-[96px]">
          ...
          >
            <div className="flex items-center w-[470px] h-[76px] gap-[14px]">
              ...
              <span className="text-white text-[24px] font-lexend font-semibold">Multi-Factor Authentication</span>
            </div>
            <p className="text-[#b3b3b3] font-lexend font-light text-[16px] leading-[150%] w-[470px] h-[96px]">
        ...
        {/* Sub Container 2: Card 3 & Card 4 (horizontal) */}
        <div className="flex flex-row gap-8 justify-center">
          {/* Card 3 */}
          <div className="flex flex-col bg-[#232323] rounded-[20px] border border-[1px] border-[#262626] p-[40px] gap-[20px] w-[550px] h-[296px] shadow-none"
            style={{
          ...
          >
            <div className="flex items-center w-[470px] h-[76px] gap-[14px]">
              ...
              <span className="text-white text-[24px] font-lexend font-semibold">Fraud Monitoring</span>
            </div>
            <p className="text-[#b3b3b3] font-lexend font-light text-[16px] leading-[150%] w-[470px] h-[96px]">
          ...
          >
            <div className="flex items-center w-[470px] h-[76px] gap-[14px]">
              ...
              <span className="text-white text-[24px] font-lexend font-semibold">Secure Mobile Banking</span>
            </div>
            <p className="text-[#b3b3b3] font-lexend font-light text-[16px] leading-[150%] w-[470px] h-[96px]">
