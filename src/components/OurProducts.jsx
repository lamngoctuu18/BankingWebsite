...
const OurProducts = () => {
	...
	return (
		<section className="w-full bg-[#181A1B] py-16 px-4 font-['Lexend',sans-serif]">
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
					<div>
						<h2 className="text-2xl font-bold text-white mb-2">
							Our{" "}
							<span className="text-[#C7FF00]">Products</span>
						</h2>
					...
					<div className="flex gap-0 mt-6 md:mt-0 bg-[#232425] rounded-full p-1 w-max">
						{tabs.map((tab, idx) => (
							<button
								...
								className={`px-7 py-2 rounded-full text-base font-semibold transition-all duration-200 outline-none border-none font-['Lexend',sans-serif] ${
									activeTab === idx
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 bg-transparent">
					{products.map((p, i) => (
						<div
							key={i}
							className={`flex flex-col items-center text-center px-4 py-8 md:px-8 md:py-12 w-full transition-all duration-300 hover:scale-105 hover:shadow-2xl group animate-slide-in-up rounded-2xl mb-4 md:mb-0 font-['Lexend',sans-serif] ${
								i < 2 ? "md:border-r md:border-[#232425]" : ""
							}`}
							style={{
								minHeight: 240,
