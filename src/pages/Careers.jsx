...
<div className="w-full max-w-7xl min-h-[700px] p-4 md:p-12 relative mb-12 overflow-hidden mx-auto">
  {/* Nền Hero */}
  ...
  {/* Ảnh nền bên phải */}
  <div className="absolute top-4 md:top-12 right-4 md:right-12 w-full md:w-[700px] h-[300px] md:h-[500px] z-10">
    <img
  ...
  <div
    className="absolute top-[320px] md:top-12 left-4 md:left-12 right-4 md:right-auto md:w-[600px] p-6 md:p-12 
               bg-[#1C1C1C] flex flex-col gap-4 md:gap-8 
               rounded-[20px] md:rounded-tl-[20px] md:rounded-bl-[20px] md:rounded-br-[80px]
               shadow-lg z-20"
  >
    <h2 className="text-4xl md:text-5xl font-bold leading-tight text-white">
      Welcome to <span className="text-[#CAFF33]">YourBank</span> Careers!
    </h2>
    <p className="text-base md:text-lg leading-relaxed text-[#B3B3B3]">
...
<div className="w-full max-w-7xl mx-auto mt-12 flex flex-col gap-12 px-4 md:px-0">
  ...
  <div className="w-full md:pr-32 flex flex-col gap-4">
    <h2 className="w-full max-w-4xl text-3xl md:text-4xl font-bold leading-tight">
      <span className="text-white">Our </span>
      <span className="text-[#CAFF33]">Values</span>
    </h2>
    <p className="w-full max-w-4xl text-[#B3B3B3] text-base leading-relaxed">
  ...
  <div className="w-full flex flex-col gap-8">
    ...
    <div className="flex flex-col md:flex-row gap-8 w-full">
      ...
      <div className="flex-1 pl-8 border-l-2 border-[#CAFF33] flex flex-col gap-4">
        <h3 className="text-3xl md:text-4xl font-bold text-[#4C4C4D]">Integrity</h3>
      ...
      {/* Box 2 */}
      <div className="flex-1 pl-8 border-l-2 border-[#CAFF33] flex flex-col gap-4">
        <h3 className="text-3xl md:text-4xl font-bold text-[#4C4C4D]">Customer Centricity</h3>
        <p className="text-base text-[#B3B3B3] leading-relaxed">
    ...
    <div className="flex flex-col md:flex-row gap-8 w-full">
      {/* Box 3 */}
      <div className="flex-1 pl-8 border-l-2 border-[#CAFF33] flex flex-col gap-4">
        <h3 className="text-3xl md:text-4xl font-bold text-[#4C4C4D]">Collaboration</h3>
        <p className="text-base text-[#B3B3B3] leading-relaxed">
      ...
      {/* Box 4 */}
      <div className="flex-1 pl-8 border-l-2 border-[#CAFF33] flex flex-col gap-4">
        <h3 className="text-3xl md:text-4xl font-bold text-[#4C4C4D]">Innovation</h3>
        <p className="text-base text-[#B3B3B3] leading-relaxed">
    ...
    <div className="flex flex-col md:flex-row gap-8 w-full">
      ...
      <div className="flex-1 p-6 md:p-10 rounded-2xl flex flex-col gap-4 shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <h3 className="text-lg md:text-xl font-bold text-white">Competitive Compensation</h3>
        </div>
        <p className="text-sm md:text-base text-[#B3B3B3] leading-relaxed mt-2 relative z-10">
      ...
      <div className="flex-1 p-6 md:p-10 rounded-2xl flex flex-col gap-4 shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <h3 className="text-lg md:text-xl font-bold text-white">Health and Wellness</h3>
        </div>
        <p className="text-sm md:text-base text-[#B3B3B3] leading-relaxed mt-2 relative z-10">
    ...
    <div className="flex flex-col md:flex-row gap-8 w-full">
      ...
      <div className="flex-1 p-6 md:p-10 rounded-2xl flex flex-col gap-4 shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <h3 className="text-lg md:text-xl font-bold text-white">Retirement Planning</h3>
        </div>
        <p className="text-sm md:text-base text-[#B3B3B3] leading-relaxed mt-2 relative z-10">
      ...
      <div className="flex-1 p-6 md:p-10 rounded-2xl flex flex-col gap-4 shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <h3 className="text-lg md:text-xl font-bold text-white">Work-Life Balance</h3>
        </div>
        <p className="text-sm md:text-base text-[#B3B3B3] leading-relaxed mt-2 relative z-10">
...
<div className="w-full max-w-7xl mx-auto mt-12 flex flex-col gap-12 px-4 md:px-0">
  {/* Text Container */}
  <div className="w-full md:pr-32 flex flex-col gap-4">
    <h2 className="w-full max-w-4xl text-3xl md:text-4xl font-bold leading-tight text-[#CAFF33]">
      Job Openings
    </h2>
    <p className="w-full max-w-4xl text-[#B3B3B3] text-base leading-relaxed">
      ...
      >
        <div className="flex flex-col gap-4 md:gap-6 w-full max-w-[500px] mx-auto">
          ...
          <div className="flex flex-col gap-4 w-full max-w-[500px]">
            <h3 className="text-white text-lg md:text-xl font-bold w-full max-w-[500px]">{job.title}</h3>
            <div className="flex flex-col md:flex-row gap-2 md:gap-4 w-full max-w-[500px]">
              <div className="flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-[40px] border border-[#23262F] text-[#B3B3B3] text-xs md:text-sm w-fit">
          ...
          <div className="flex flex-col gap-4 w-full max-w-[500px]">
            ...
            <div className="flex flex-col gap-2 w-full max-w-[500px] overflow-hidden">
              <h4 className="text-white text-base md:text-lg font-semibold w-full max-w-[500px]">About This Job</h4>
              <p className="text-[#B3B3B3] text-sm md:text-base leading-relaxed w-full max-w-[500px] line-clamp-5 overflow-hidden">
                {job.about}
              </p>
            </div>
            {/* Requirements & Qualifications */}
            <div className="flex flex-col gap-2 w-full max-w-[500px]">
              <h4 className="text-white text-base md:text-lg font-semibold w-full max-w-[500px]">Requirements & Qualifications</h4>
              <div className="flex flex-col gap-2 w-full max-w-[500px]">
                {job.requirements.map((req, i) => (
                  <div key={i} className="flex items-center gap-2 text-[#B3B3B3] text-sm md:text-base">
        ...
        {/* Button */}
        <button className="w-[120px] md:w-[140px] h-[40px] md:h-[48px] px-4 md:px-6 py-1.5 md:py-2 rounded-[60px] bg-[#CAFF33] text-black font-semibold text-sm md:text-base self-start mt-4 md:mt-6 hover:brightness-95 transition">
          Apply Now
        </button>
      </div>
    ))}
