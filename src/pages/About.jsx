...
const About = () => {
  return (
    <div className="relative bg-[#0e0e0e] text-white py-20 md:py-[153px] px-4 md:px-20 overflow-hidden space-y-10 md:space-y-[60px]">
      {/* About Container */}
      <div className="w-full max-w-[1279px] min-h-[648px] p-4 md:p-12 relative mb-12 overflow-hidden mx-auto">
        ...
        {/* Dots overlay */}
        <div className="absolute top-0 right-0 w-[100px] h-[100px] md:w-[334px] md:h-[317px] z-20">
          <img
            src="public/images/dots.png"
            alt="dots"
            className="w-full h-full object-cover opacity-30 pointer-events-none rotate-90"
            draggable={false}
          />
        </div>
        ...
        {/* Text Section */}
        <div
          className="absolute left-4 right-4 md:left-12 md:right-auto md:w-[658px] p-6 md:p-[60px] bg-[#181818] flex flex-col gap-5 rounded-[20px] md:rounded-tl-[20px] md:rounded-bl-[20px] md:rounded-br-[60px] z-30
            bottom-6 md:top-12 md:bottom-auto"
        >
          <p className="text-sm text-white font-medium">Welcome to YourBank</p>
          <h1 className="text-2xl md:text-[48px] font-bold leading-tight">
            Where Banking Meets <br /> <span className="text-lime-400">Excellence!</span>
          </h1>
      ...
      <div className="w-full max-w-[1280px] mx-auto flex flex-col gap-6 md:gap-10">
        <div>
          <h2 className="text-lime-400 text-xl md:text-2xl font-bold mb-2">Mission & Vision</h2>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            {/* Text Container */}
            <div className="flex flex-col justify-center relative mt-6 md:mt-0 flex-1 px-0 min-w-0">
              {/* Vertical bar */}
              <span
              ...
              />
              <h3 className="text-white font-bold mb-2 font-lexend text-2xl md:text-[32px] leading-[40px] mb-3">
                Mission
              </h3>
              <p className="text-gray-300 font-lexend font-light text-[15px] md:text-[18px] leading-[150%] w-full min-h-[120px]">
      ...
      <div className="w-full max-w-[1280px] mx-auto flex flex-col gap-8 md:gap-[60px]">
        <div>
          <h2 className="text-lime-400 text-xl md:text-2xl font-bold mb-2">Press Releases</h2>
          <p className="text-gray-300 text-xs md:text-sm">
        ...
        <div className="flex flex-col gap-6 md:gap-[40px]">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-[40px]">
            ...
            <div className="flex flex-col bg-[#181818] rounded-[20px] p-0 w-full max-w-[630px] min-h-[400px] overflow-hidden shadow-md mx-auto md:mx-0">
              <img
                src="public/images/Press 1.png"
                alt="press1"
                className="w-full max-w-[582px] h-[180px] md:h-[277px] object-cover rounded-[16px] mx-auto mt-6 mb-4"
              />
              <div className="px-6 pb-6">
                <h3 className="text-white font-semibold mb-4 max-w-[534px] min-h-[56px] text-lg md:text-[18px] font-lexend leading-[28px]">
                ...
                <p className="text-gray-300 max-w-[534px] min-h-[80px] font-lexend font-light text-sm md:text-base leading-[22px] text-[#B3B3B3]">
            ...
            <div className="flex flex-col bg-[#181818] rounded-[20px] p-0 w-full max-w-[630px] min-h-[400px] overflow-hidden shadow-md mx-auto md:mx-0">
              ...
              <div className="px-6 pb-6">
                ...
                <p className="text-gray-300 max-w-[534px] min-h-[80px] font-lexend font-light text-sm md:text-base leading-[22px] text-[#B3B3B3]">
                  ...
                  This initiative includes a range of sustainable banking products and services, such as green loans, eco-friendly investment options, and paperless banking solutions.
                  By incorporating sustainable practices into our operations, we aim to contribute to a greener future while providing innovative banking solutions to our customers.
                </p>
              </div>
            </div>
            {/* Card 4 */}
